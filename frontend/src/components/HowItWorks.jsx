            ...
            >
              <div>
                <div className="flex items-center justify-between mb-4 sm:mb-6">
                  ...
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-white/80 border border-white flex items-center justify-center shadow-sm">
                    <Icon size={20} className="stroke-[2.5]" />
                  </div>
                </div>

                <h3 className="font-heading text-xl sm:text-2xl font-bold mb-1.5 sm:mb-2">
                  {item.title}
                </h3>
              ...
              <div className="mt-5 sm:mt-8 pt-3 sm:pt-4 border-t border-black/5 flex items-center gap-2 text-[11px] sm:text-xs font-heading font-bold opacity-80">
