        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-6 space-y-3 sm:space-y-4">
            ...
            <div className="pt-1 sm:pt-2 flex flex-wrap gap-1.5 sm:gap-2">
              <span className="px-2.5 sm:px-3 py-1 rounded-xl bg-cream-100 border border-clay-border text-xs font-heading font-bold text-slate-700">
                🏷️ Pothole
              </span>
              <span className="px-2.5 sm:px-3 py-1 rounded-xl bg-cream-100 border border-clay-border text-xs font-heading font-bold text-slate-700">
                ⚡ Crack
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              {specs.map((spec, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="p-3 sm:p-4 rounded-2xl bg-cream-100/70 border-2 border-clay-border flex items-start gap-3 sm:gap-3.5 shadow-inner"
                  >
                    ...
                    <div>
                      <p className="text-[10px] sm:text-[11px] font-heading font-bold uppercase tracking-wider text-slate-400">
                        {spec.label}
                      </p>
                      <p className="font-heading font-extrabold text-xs sm:text-sm lg:text-base text-slate-900 mt-0.5">
                        {spec.value}
                      </p>
                    </div>
                  </div>
